...
"""
before_model_callback — Dispute Agent
"""
...
ESCALATION_MAP = {
    "escalate": {
        "text": "I understand. Let me connect you with a representative who can help. Please hold.",
        "payload": {
    ...
    "escalate_tier_2": {
        "text": "This dispute request requires specialized Tier 2 review. Let me transfer you to our Tier 2 billing support team. Please hold.",
        "payload": {
            "escalation_reason": "_escalation_reason",
            "main_topic": "_escalation_topic",
...
def before_model_callback(callback_context: CallbackContext, llm_request: LlmRequest) -> Optional[LlmResponse]:
    """Intercepts LLM request to handle deterministic dispute escalations."""
